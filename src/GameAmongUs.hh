...
class GameAmongUs : public Game
{
  ...
  private:
    void Update_Start(unsigned int joystickX, unsigned int joystickY, bool joystickPressed, unsigned long elapsed);
    void Update_RoundTitle(unsigned int joystickX, unsigned int joystickY, bool joystickPressed, unsigned long elapsed);
    void Update_RoundMovement(unsigned int joystickX, unsigned int joystickY, bool joystickPressed, unsigned long elapsed);
    void Update_Choosing(unsigned int joystickX, unsigned int joystickY, bool joystickPressed, unsigned long elapsed);
    void Update_Reveal(unsigned int joystickX, unsigned int joystickY, bool joystickPressed, unsigned long elapsed);
